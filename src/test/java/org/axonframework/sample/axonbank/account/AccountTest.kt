...
class AccountTest {
    ...
    fun DepositMoney(){
        fixture.given(AccountCreatedEvent("1234", 1000))
                .`when`(DepositMoneyCommand("1234", "tx1", 1000))
                .expectEvents(MoneyDepositedEvent("1234", "tx1", 1000, 1000))
    }
    @Test
    fun DepositMoneyTwice(){
        fixture.given(AccountCreatedEvent("1234", 1000),
                MoneyDepositedEvent("1234", "tx1",1000, 1000))
                .`when`(DepositMoneyCommand("1234", "tx1", 1000))
                .expectEvents(MoneyDepositedEvent("1234", "tx1", 1000, 2000))
    }
}